...
<section class="section" style="padding-top:3.5rem">
  <div class="wrap" style="display:grid; grid-template-columns:1fr 1.1fr; gap:3rem; align-items:start">
    <div>
      ...
      <h2 style="margin:.6rem 0 1rem">We would love to hear from you</h2>
      <p class="muted">Whether you want to partner with the foundation, join the discipleship journey, or simply learn more — send a message and we’ll respond.</p>
